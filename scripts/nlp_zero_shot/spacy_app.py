...
def main():
    ...
    with st.form("my_form"):
        text = st.text_area("* Text for zero-shot NER",
        ...
        descriptions = st.text_area("* Descriptions (one entity description per line)", DEFAULT_ENTITY_DESCRIPTIONS.strip())
        ...
        if submitted:
            ...
            ents = [
                ...
                for entity_id, idx_list in response['entities_dict'].items() for i, j in idx_list
            ]
